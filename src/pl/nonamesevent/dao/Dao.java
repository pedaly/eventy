...
public enum Dao {
	...
	public void add(String city, Date dateOfEvent, String desc, double lat,
...
//		Query q = em.createQuery("SELECT e FROM Event e WHERE lat < ':latMin'",Event.class);
//		q.setParameter("latMin", (double) boundingCords.get("latMin"));
